      ...
      <section className="relative">
        ...
        <div className="mx-auto max-w-6xl px-4 py-10">
          <div className="mb-6 rounded-xl bg-gradient-to-r from-blue-900/90 via-indigo-800/90 to-purple-800/90 p-6 text-white shadow-lg">
            <h1 className="[font-family:var(--font-display)] text-4xl">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <div>
            ...
            <p className="mt-2 text-sm opacity-80">
              ...
              <a
                className="underline"
                target="_blank"
                href="https://www.regsciconsort.com/lake-erie-shipwrecks/dean-richmond/"
              >
                Dean Richmond
              </a>
              . Model courtesy of{" "}
              <a
                href="https://3dshipwrecks.org"
                target="_blank"
                className="underline"
              >
                3DShipwrecks
            ...
            <div className="mt-4 rounded-md bg-[color:var(--color-goals-bg)] p-4 text-[color:var(--color-header-text)]">
              ...
              <ul className="list-disc pl-6 text-sm opacity-90">
                <li>
                  iOS: Tap &quot;View in AR&quot; to launch USDZ in Quick Look.
                </li>
                <li>
                  Android: Tap &quot;View in AR&quot; to launch Scene Viewer.
                </li>
                <li>
                  VR: Tap &quot;View in VR&quot; then the headset icon. Use a
                  mobile headset case for best experience.
                </li>
              </ul>
            </div>
          </div>
          <div className="space-y-4">
            ...
            <p className="opacity-90">
              The Tom Ridge Environmental Center (TREC) is dedicated to the
              3,200 acres of Presque Isle, combining research, education, and
              visitor services in one destination. Explore exhibits, climb the
              75&apos; glass tower, and learn how to keep Presque Isle pristine.
            </p>
            ...
            <div className="rounded-md bg-[color:var(--color-goals-bg)] p-4 text-[color:var(--color-header-text)]">
              ...
              <ul className="list-disc pl-6 text-sm opacity-90">
                <li>
                  Free general admission to exhibits and orientation movie.
                </li>
